...
const SearchableCitySelect = ({ selectedCity, onChange }) => {
  ...
  const cities = [
    "Aalo", "Adilabad", "Agartala", "Agra", "Ahmedabad", "Ajmer",
    "Bengaluru", "Bhopal", "Bhubaneswar", "Chennai", "Delhi", "Dehradun",
    "Hyderabad", "Indore", "Jaipur", "Kolkata", "Lucknow", "Mumbai",
    "Nagpur", "Patna", "Pune", "Raipur", "Shimla", "Surat", "Vadodara"
  ];
  ...
  return (
    <div className="relative w-full mb-4" ref={dropdownRef}>
      ...
      >
        <span className={`${!selectedCity ? "text-gray-500" : "text-gray-800"}`}>
          {displayValue}
        </span>
